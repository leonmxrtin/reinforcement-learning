...
add the command-line script for playing against a saved JSON policy. All final
design decisions, code behavior, and experimental conclusions were reviewed by the
student and should be understood before submission and defense.
